...
-- Clear highlights on search when pressing <Return> in normal mode
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>', builtin.buffers, { desc = '[ ] Findexisting buffers' })

      -- Open telescope
      vim.keymap.set('n', '<leader>o', ':Telescope <CR>', { noremap = true, silent = true })
  ...
  { -- Main LSP Configuration
    ...
    config = function()
      ...
      --
      -- To understand lsp vs treesitter, you can check out the wonderfully `:help lsp-vs-treesitter`
